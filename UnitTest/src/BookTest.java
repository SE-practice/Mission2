...
class BookTest {
    ...
    void testBinarySearchBook(){
        ...
        System.out.println("검색 결과:");
        System.out.println(bookManager.search_bs(book1.getId()));

        System.out.println("검색 결과:");
        System.out.println(bookManager.search_bs(book2.getId()));

        System.out.println("검색 결과:");
        System.out.println(bookManager.search_bs(book3.getId()));

        assertThrows(IllegalArgumentException.class, () -> bookManager.search_bs("4"));
    }
